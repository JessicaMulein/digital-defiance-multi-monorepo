...
console.log(
  'SettingsComponent: settingsManager loaded in background',
...
receiveMessages(
  (
    ...
    if (message.type === MessageType.GlobalSettingsUpdate) {
      console.log(
        'background.ts: loading updates settings from extension',
        message.data
      );
      settingsManager.loadGlobalSettings();
    } else if (message.type === MessageType.LocalSettingsUpdate) {
      console.log(
        'background.ts: loading updates settings from tab',
        message.data
      );
